...
public class LC_0341_FlattenNestedListIterator_my1 implements Iterator<Integer> {
    
        private List<Integer> list;
        private int cur = 0;
    
        public LC_0341_FlattenNestedListIterator_my1(List<NestedInteger> nestedList) {
